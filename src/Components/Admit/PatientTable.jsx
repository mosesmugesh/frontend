...
const PatientTable = () => {
  ...
  const handleDeletePatient = async (patientId) => {
    try {
      ...
      const response = await fetch(`http://localhost:9000/admit/${patientId}`, {
        method: "DELETE",
      });
  ...
  const handleUpdatePatient = async () => {
    try {
      ...
      const response = await fetch(
        `http://localhost:9000/update/${patientId}`,
        {
          method: "PUT",
          headers: {
        ...
        <div style={{ width: "100%", padding: "10px", marginLeft: "50px" }}>
          ...
          >
            ...
            <h2 style={{ marginLeft: "50px", marginTop: "-50px" }}>
              To Edit Admit Patient Detials, please enter the details
            </h2>
          </div>
          <Typography
            variant="h3"
